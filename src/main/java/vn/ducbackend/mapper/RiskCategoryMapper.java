...
public interface RiskCategoryMapper {
    ...
    RiskCategory toRiskCategories(RiskCategoryRequest riskCategoryRequest);


    RiskCategoryDetailResponse toDetailDTO(RiskCategory entity);

    // method hỗ trợ update từ DTO sang entity
    void updateRiskCategoryFromDto(RiskCategoryUpdateDTO dto, @MappingTarget RiskCategory entity);

    BasicInfoDTO toLinkDTO(RiskCategory entity );
}
